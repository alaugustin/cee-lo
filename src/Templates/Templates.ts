  ...
  return `
    <div class="${commonClass} ${cardAlignmentClass}">
      ...
      <div class="diceHolder flex flex-row">
        <div class="font-bold">Die 1: <span class="die1">-</span></div>
        <div class="font-bold px-2">Die 2: <span class="die2">-</span></div>
        <div class="font-bold">Die 3: <span class="die3">-</span></div>
      </div>
    </div>
  `;
}
